...
export default (function (props) {
    ...
    var Prepend = function () { return (React.createElement("span", { className: " flex flex-shrink-0 w-24 mr-2 h-4  overflow-hidden" },
        React.createElement(Select, { name: "lala", type: "select", options: options, variant: "opaque", size: "xs" }))); };
    return (React.createElement(React.Fragment, null,
        React.createElement(Text, __assign({}, props, { ref: input, prepend: React.createElement(Prepend, null) }))));
});
