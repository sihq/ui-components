...
var Phone = function (props) {
    ...
    var Prepend = function () { return (React.createElement("span", { className: " flex flex-shrink-0 w-24 mr-2 h-4  overflow-hidden" },
        React.createElement(Select, __assign({}, { name: "".concat(props.name, ".country") }, { type: "select", options: options, variant: "opaque", size: "xs" })))); };
    return (React.createElement(React.Fragment, null,
        React.createElement(Text, __assign({}, __assign(__assign({}, props), { name: "".concat(props.name, ".number") }), { ref: input, prepend: React.createElement(Prepend, null) }))));
};
