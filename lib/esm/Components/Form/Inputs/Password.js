...
export default (function (props) {
    ...
    var Append = function () { return (React.createElement("span", { className: "flex flex-shrink-0 items-center justify-center ml-2" },
        React.createElement("button", { type: "button", onClick: function () {
            ...
            }, className: "focus:outline-none z-10 right-2 p-1 rounded-full text-xs text-gray-400 hover:text-blue-500 ".concat(hidden ? '' : 'bg-gray-200') }, hidden ? React.createElement(EyeIcon, { className: "h-4 w-4" }) : React.createElement(EyeOffIcon, { className: "h-4 w-4" })))); };
