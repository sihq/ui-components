    ...
    return _a = /** @class */ (function (_super) {
                ...
                return new Promise(function (resolve, reject) {
                    axios
                        ...
                        payload.map(function (data, index) {
                            _this.states[index].controller.setState(data.state);
                        });
                        resolve(response);
                    })
            ...
            Reactive.prototype.onDispatch = function (data) {
                ...
                Queue.enqueue(new Promise(function (resolve) {
                    var payload = _this.states.map(function (_a) {
                        ...
                        var payload = __assign(__assign({ action: isCaller ? 'onRequest' : 'onDispatch' }, (isCaller ? { event: data.event } : {})), { controller: controller.controller, state: controller.state });
                        return payload;
                    });
                    _this.request(payload).then(function () {
                        resolve(true);
            ...
            Reactive.prototype.render = function () {
                ...
                return (React.createElement(ReactiveContext.Provider, { value: { uuid: this.uuid } },
                    htmlResponse ? (React.createElement("div", { className: "fixed inset-0 bg-black bg-opacity-75", onClick: function () { return _this.setState({ htmlResponse: null }); } },
