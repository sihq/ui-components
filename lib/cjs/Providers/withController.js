...
function withController(Properties, WrappedComponent) {
    var Controller = /** @class */ (function (_super) {
        ...
        Controller.prototype.update = function (state, triggerDispatch) {
            ...
            this.setState(state, function () { return (triggerDispatch ? _this.dispatch() : null); });
        };
        Controller.prototype.render = function () {
            return (react_1.default.createElement(ReactiveControllerContext_1.ReactiveControllerContext.Provider, { value: { state: this.state, update: this.update, dispatch: this.dispatch } },
