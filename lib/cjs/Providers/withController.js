...
function withController(Properties, WrappedComponent) {
    var Controller = /** @class */ (function (_super) {
        ...
        Controller.prototype.render = function () {
            return (react_1.default.createElement(ReactiveControllerContext_1.ReactiveControllerContext.Provider, { value: { state: this.state.data, update: this.update, dispatch: this.dispatch } },
