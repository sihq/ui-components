...
function Prepend(props) {
    ...
    return (react_1.default.createElement("span", { className: " flex flex-shrink-0 w-24 mr-2 h-4  overflow-hidden" },
        react_1.default.createElement(Contexts_1.FieldContext.Provider, { value: { name: "country", type: 'select', variant: 'opaque', size: 'xs' } },
            react_1.default.createElement(Store_1.default, { onChange: function (value) { return props.onChange(value); } },
