...
exports.Sample = exports.Transfer = exports.ToggleButton = exports.Toggle = exports.Image = exports.DateOfBirth = exports.Address = exports.Currency = exports.Textarea = exports.Text = exports.Editor = exports.Phone = exports.Duration = exports.Timezone = exports.Search = exports.Select = exports.Password = void 0;
...
var Sample = function () {
    ...
    return (react_1.default.createElement(Contexts_1.ReactiveControllerContext.Provider, { value: { update: setState, state: state } },
        react_1.default.createElement("div", { className: "space-y-4", style: { width: 1000 } },
            ...
            react_1.default.createElement("div", { className: "flex", style: { height: 500 } },
                react_1.default.createElement(Field_1.default, { name: "editor", type: "editor", label: "Editor:" })),
