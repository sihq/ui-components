...
exports.default = react_1.default.forwardRef(function (props, ref) {
    var _a, _b, _c, _d;
    var _e = (0, react_1.useContext)(reactive_1.ControllerContext), setValue = _e.setValue, value = _e.value;
    ...
    var _f = (0, react_1.useState)(0), uploadProgress = _f[0], setUploadProcess = _f[1];
    function upload(e) {
        // @ts-ignore
        ...
        react_1.default.createElement(Wrapper_1.default, __assign({}, props),
            ...
            react_1.default.createElement("div", { className: "flex flex-col relative" },
                react_1.default.createElement("div", { className: "flex items-center" },
                    react_1.default.createElement("div", null, value(name) ? (react_1.default.createElement("div", { className: "aspect-video h-10 bg-gray-200 rounded mr-2 bg-center bg-cover", style: {
                            backgroundImage: "url(".concat(
                            // @ts-ignore
                            (_a = value(name)) === null || _a === void 0 ? void 0 : _a.store).concat(
                            // @ts-ignore
                            ((_b = value(name)) === null || _b === void 0 ? void 0 : _b.status) === 'staged' ? 'tmp/' : '').concat(
                            // @ts-ignore
                            (_c = value(name)) === null || _c === void 0 ? void 0 : _c.id, ")"),
                        } })) : null),
                    react_1.default.createElement("input", __assign({ type: "file", accept: "image/png, image/jpeg, image/jpg", ref: ref, id: "".concat((_d = id !== null && id !== void 0 ? id : name) !== null && _d !== void 0 ? _d : label) }, { name: name, disabled: disabled, placeholder: placeholder, onChange: onChange, onKeyDown: onKeyDown, onKeyUp: onKeyUp, onFocus: onFocus }, (onChange ? {} : { onChange: upload }), { className: "outline-none bg-transparent flex-1 w-full ml-2" }))),
