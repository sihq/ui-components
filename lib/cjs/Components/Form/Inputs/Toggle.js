...
exports.default = react_1.default.forwardRef(function (props, ref) {
    var _a;
    var _b = (0, react_1.useContext)(reactive_1.ControllerContext).bind, bind = _b === void 0 ? function () { return ({}); } : _b;
    var id = props.id, name = props.name, label = props.label, _c = props.defer, defer = _c === void 0 ? true : _c, append = props.append, prepend = props.prepend, disabled = props.disabled, placeholder = props.placeholder;
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("span", { "data-input": "checkbox", className: "flex relative flex-col text-gray-600 focus-within:text-blue-500 -ml-1 -mr-2 rounded p-1 pr-2 hover:text-blue-500 cursor-pointer text-xs group" },
            react_1.default.createElement("span", { "data-input": "toggle", className: "flex justify-start items-center relative" },
                prepend,
                react_1.default.createElement("div", { className: "relative flex-shrink-0 rounded-full w-7 h-4 transition duration-200 ease-linear" },
                    react_1.default.createElement("input", __assign({ type: "checkbox", className: "opacity-0 absolute inset-0 w-full h-full z-40", ref: ref, id: "".concat((_a = id !== null && id !== void 0 ? id : name) !== null && _a !== void 0 ? _a : label) }, { name: name, disabled: disabled, placeholder: placeholder }, bind({ defer: defer, name: name }))),
