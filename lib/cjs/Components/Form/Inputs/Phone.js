...
exports.default = (function (props) {
    ...
    var Prepend = function () { return (react_1.default.createElement("span", { className: " flex flex-shrink-0 w-24 mr-2 h-4  overflow-hidden" },
        react_1.default.createElement(Select_1.default, { name: "lala", type: "select", options: options, variant: "opaque", size: "xs" }))); };
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Text_1.default, __assign({}, props, { ref: input, prepend: react_1.default.createElement(Prepend, null) }))));
});
