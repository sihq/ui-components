...
var Phone = function (props) {
    ...
    var options = Object.entries(exports.COUNTRY_CODES).map(function (country) {
        var name = country[0];
        var code = country[1].code;
        return { value: name, text: "".concat(name, " +").concat(code) };
    });
    var Prepend = function () { return (react_1.default.createElement("span", { className: " flex flex-shrink-0 w-24 mr-2 h-4  overflow-hidden" },
        react_1.default.createElement(InputSelect_1.default, __assign({}, { name: "".concat(props.name, ".country") }, { type: "select", options: options, variant: "opaque", size: "xs" })))); };
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Text_1.default, __assign({}, __assign(__assign({}, props), { name: "".concat(props.name, ".number") }), { ref: input, prepend: react_1.default.createElement(Prepend, null) }))));
};
