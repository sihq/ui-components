...
exports.default = (function (props) {
    var Prepend = function () { return (react_1.default.createElement("span", { className: "flex flex-shrink-0 items-center p-0.5 justify-center mr-2 text-gray-400 text-xs" },
