...
exports.default = react_1.default.forwardRef(function (props, ref) {
    var _a;
    var _b = (0, react_1.useContext)(Controller_1.ControllerContext), value = _b.value, setValue = _b.setValue;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("button", __assign({ className: "".concat(className, " ").concat(value(name)
                ...
                : 'border-gray-200 bg-gray-50 hover:border-gray-300 hover:bg-gray-100'), ref: ref, id: "".concat((_a = id !== null && id !== void 0 ? id : name) !== null && _a !== void 0 ? _a : label) }, { name: name, disabled: disabled }, { onClick: function () { return setValue(name, !value(name)); } }),
