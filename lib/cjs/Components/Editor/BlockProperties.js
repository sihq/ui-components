...
var BlockProperties = function (_a) {
    ...
    var value = (0, react_1.useContext)(Controller_1.ControllerContext).value;
    ...
    return (react_1.default.createElement("div", { className: "bg-gray-50 w-72 border-l border-gray-300 p-3 px-5 scrollbar" },
